...
use BaksDev\Search\RediSearch\Aggregate\Builder as AggregateBuilder;
use BaksDev\Search\RediSearch\Aggregate\BuilderInterface as AggregateBuilderInterface;
use BaksDev\Search\RediSearch\Document\AbstractDocumentFactory;
use BaksDev\Search\RediSearch\Document\DocumentInterface;
use BaksDev\Search\RediSearch\Exceptions\NoFieldsInIndexException;
use BaksDev\Search\RediSearch\Exceptions\UnknownIndexNameException;
use BaksDev\Search\RediSearch\Fields\FieldInterface;
use BaksDev\Search\RediSearch\Fields\GeoField;
use BaksDev\Search\RediSearch\Fields\NumericField;
use BaksDev\Search\RediSearch\Fields\TagField;
use BaksDev\Search\RediSearch\Fields\TextField;
use BaksDev\Search\RediSearch\Query\Builder as QueryBuilder;
use BaksDev\Search\RediSearch\Query\BuilderInterface as QueryBuilderInterface;
use BaksDev\Search\RediSearch\Query\SearchResult;
use BaksDev\Search\RedisRaw\Exceptions\RawCommandErrorException;
use RedisException;
...
class Index extends AbstractIndex implements IndexInterface
{
     ...
     * @return SearchResult
     * @throws \BaksDev\Search\RedisRaw\Exceptions\RedisRawCommandException
     */
